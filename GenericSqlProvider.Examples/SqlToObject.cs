...
{
    public class SqlToObject<T>
    {
        IDbConnection Database;
        IDbTransaction Transaction;

        public SqlToObject(IDbConnection dbConnection, IDbTransaction dbTransaction)
        {
        ...
        public virtual IEnumerable<T> GetRecordsWhere(string sql)
        {
