...
{
    public class GenericOracleParameterCollection : IDataParameterCollection
    {
        ...
        public GenericOracleParameterCollection(ref IDataParameterCollection parameterCollection)
        {
